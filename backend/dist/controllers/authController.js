...
const signupLimiter = (0, authService_1.createRateLimiter)(15 * 60 * 1000, 5, 'Too many signup attempts, please try again later.');
...
exports.signin = [
    ...
    (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            res.status(200).json({ message: 'Signed in successfully', token: (0, authService_2.generateJwt)(user) });
        }
        catch (err) {
            console.error(err);
