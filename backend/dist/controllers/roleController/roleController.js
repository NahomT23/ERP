...
exports.manufacture_only = exports.customer_only = exports.inventory_only = exports.sales_only = exports.admin_only = void 0;
...
exports.customer_only = [
    authMiddleware_1.authentication,
    (0, authMiddleware_1.authorize)([client_1.UserRole.CUSTOMER]),
    (req, res) => {
        res.status(200).json({ message: 'This is an inventory-only route' });
    },
];
